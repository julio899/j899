...
function warning(x) {
    if (x.length === 2) {
        console.log("%c " + x[0] + " %c warning", "background-color:#565656;color:#fff;border-top-left-radius:4px;border-bottom-left-radius:4px;padding-right:4px", "background-color:#D3AB1F;padding:0 4px;color:#fff;border-top-right-radius:4px;border-bottom-right-radius:4px;")
    } else if (x.length > 2) {
...
function danger(x) {
    if (x.length === 2) {
        console.log("%c " + x[0] + " %c warning", "background-color:#565656;color:#fff;border-top-left-radius:4px;border-bottom-left-radius:4px;padding-right:4px", "background-color:#cb553f;padding:0 4px;color:#fff;border-top-right-radius:4px;border-bottom-right-radius:4px;")
    } else if (x.length > 2) {
